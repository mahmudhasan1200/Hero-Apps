      ...
      <div className="max-w-7xl mx-auto">
        ...
        */}
        ...
        <div className="flex justify-center mt-12">
          <button className="btn bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-lg px-8 h-11 border-none shadow-sm min-h-0 normal-case text-sm">
            Show All
          </button>
        </div>
      </div>
